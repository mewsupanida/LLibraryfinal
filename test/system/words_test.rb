...
class WordsTest < ApplicationSystemTestCase
  ...
  test "creating a Word" do
    ...
    fill_in "Search count", with: @word.search_count
    fill_in "Term", with: @word.term
    fill_in "Term acronym", with: @word.term_acronym
    fill_in "Term definition", with: @word.term_definition
    fill_in "Term tags", with: @word.term_tags
